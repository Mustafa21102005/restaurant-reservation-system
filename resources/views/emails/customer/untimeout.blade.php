...
<head>
    <meta charset="UTF-8">
    <title>Timeout Notification</title>
</head>
        ...
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0"
                    style="background: white; padding: 40px; border-radius: 8px; box-shadow: 0 5px 10px rgba(0,0,0,0.05);">
                    <tr>
                        <td align="center">
                            <h1 style="font-size: 24px; color: #333; margin-bottom: 20px;">
                                Dear, {{ $timeout->user->name }}
                            </h1>

                            <p style="font-size: 16px; color: #555; line-height: 1.5;">
                                We'd like to inform you that your timeout due to the following reason has expired:
                            </p>
