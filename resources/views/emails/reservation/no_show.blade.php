...
<head>
    <meta charset="UTF-8">
    <title>Reservation Missed</title>
</head>
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <p style="font-size: 16px; color: #555; line-height: 1.5;">
                                You missed your reservation scheduled for:<br><br>
                                <strong>{{ \Carbon\Carbon::parse($reservation->datetime)->format('F j, Y, g:i A') }}</strong><br><br>
                                Your reservation has been marked as <strong style="color: #e74c3c;">No
                                    Show</strong>.<br>
