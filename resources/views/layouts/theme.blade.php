        ...
        <header class="s-header">
            <div class="s-header__block">
                ...
                <div class="s-header__cta">
                    <nav class="mx-3 flex flex-1 justify-end">
                        @auth
                            @role('customer')
                                <a href="{{ route('website.reservation') }}" class="btn btn--primary s-header__cta-btn">
                                    Book a Table
                                </a>
                            @endrole

                            @role('admin')
                                <a href="{{ route('dashboard') }}" class="btn btn--primary s-header__cta-btn">
                                    Go to Dashboard
                                </a>
                            @endrole
                            ...
                            <form method="POST" action="{{ route('logout') }}" style="display:inline-block;">
                                @csrf
                                <a href="{{ route('logout') }}" class="btn btn--primary s-header__cta-btn"
                        ...
                        @else
                            <a href="{{ route('login') }}" class="btn btn--primary s-header__cta-btn">Login</a>

                            <a href="{{ route('register') }}" class="btn btn--primary s-header__cta-btn">
                                Register
                            </a>
                        @endauth
                    </nav>
            ...
            <nav class="s-header__nav">
                ...
                <ul class="s-header__nav-links">
                    ...
                    <li class="dropdown">
                        <a href="#0" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"
                            onclick="toggleDropdown(event)">Reservations</a>
                        <ul style="display: none;">
                            <li><a href="{{ route('website.reservation') }}">Book a Reservation</a></li>
                            <li><a href="{{ route('website.myReservation') }}">My Reservations</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#0" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"
        ...
        <footer id="footer" class="s-footer">
            <div class="row s-footer__top row-x-center">
                <div class="column xl-4 lg-6 tab-8 mob-12">
                    <a href="{{ route('website.reservation') }}" class="btn btn--primary btn--large u-fullwidth">
                        Book a Table
                    </a>
                </div>
            </div>
                ...
                <div class="column xl-6 md-12 s-footer__block s-footer__info">
                    <div class="row">
                        ...
                        <div class="column xl-6 lg-12">
                            <h5>Contacts</h5>
                            <ul class="link-list">
                                <li><a href="mailto:#0">info@maillard.com</a></li>
            ...
            <div class="row s-footer__bottom">
                ...
                <div class="column xl-6 lg-12">
                    <p class="ss-copyright">
                        <span>© Copyright Maillard 2026</span>
                        <span>Design by <a href="https://styleshout.com/" target="_blank">StyleShout</a></span>
                    </p>
                </div>
